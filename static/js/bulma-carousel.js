	...
	return /******/ (function (modules) {
		...
		/******/ [
			...
			/***/ function (module, __webpack_exports__, __webpack_require__) {
				...
				var isString = function isString(unknown) {
					return (
						...
						(!!unknown && (typeof unknown === "undefined" ? "undefined" : _typeof(unknown)) === "object" && Object.prototype.toString.call(unknown) === "[object String]")
					);
				};
			...
			/***/ function (module, __webpack_exports__, __webpack_require__) {
				...
				var isSafari =
					navigator.userAgent.toLowerCase().indexOf("safari") >= 0 && navigator.userAgent.toLowerCase().indexOf("chrome") < 0 && navigator.userAgent.toLowerCase().indexOf("android") < 0;
									...
									if (this.slider.state.next > 0) {
										if (this.slider.state.next < this.slider.state.length) {
											if (
												...
												Object(__WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* isInViewport */])(this.slider._slides[this.slider.state.length - 1], this.slider.wrapper)
											) {
