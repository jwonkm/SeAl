# Semantic Alignment for Pose-Invariant Identity Preserving Diffusion (CVPR 2026)
...
This is the official implementation of the paper *"Semantic Alignment for Pose-Invariant Identity Preserving Diffusion (CVPR 2026)"*
